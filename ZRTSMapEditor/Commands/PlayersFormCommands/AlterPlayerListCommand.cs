...
namespace ZRTSMapEditor
{
    ...
    /// </summary>
    public class AlterPlayerListCommand : ModelCommand
    {
        private List<AlterPlayerCommand> adapters;

        /// <summary>
        /// Ensures that a list of adapters are given to the committer.
        /// </summary>
        private AlterPlayerListCommand()
        {
        }

        public AlterPlayerListCommand(List<AlterPlayerCommand> adapters)
        {
        ...
        public void Do()
        {
            if (CanBeDone())
            {
                foreach (AlterPlayerCommand adapter in adapters)
                {
                    adapter.Do();
                }
            }
