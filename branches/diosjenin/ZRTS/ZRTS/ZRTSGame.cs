...
namespace ZRTS
{
    ...
    public class ZRTSGame : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Initialize()
        {
            ...
            this.testGameController.addUnit(new ZRTSModel.Entities.Unit(testGameController.scenario.getWorldPlayer(), 20, 100), 5, 10);
            this.testGameController.addUnit(new ZRTSModel.Entities.Unit(testGameController.scenario.getWorldPlayer(), 20, 100), 10, 5);
